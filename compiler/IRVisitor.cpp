...
antlrcpp::Any IRVisitor::visitExprAddSub(ifccParser::ExprAddSubContext *ctx)
{
    ...
    IRInstr * instr1 = new IRInstrAffect(current_cfg->current_bb, to_string(infosDroite.location), "0");
...
antlrcpp::Any IRVisitor::visitExprCompSupInf(ifccParser::ExprCompSupInfContext *ctx){
    ...
    IRInstr * instrr = new IRInstrAffect(current_cfg->current_bb, to_string(infosDroite.location), "0");
    current_cfg->current_bb->add_IRInstr(instrr);
